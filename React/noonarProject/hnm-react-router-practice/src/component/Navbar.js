    ...
    return (
        <div className='main-header'>
            ...
            <div className='main-logo'>
                ...
                {/* github 에 빌드 한 후 http://localhost:3000에서 확인 하고 싶을 땐 이미지 있는 경로로 표시해 줘야함..ㅠ */}
                <img width={90} src="https://dbfla6302.github.io/HNM-React/assets/H&M-Logo.png" onClick={goToHome} alt="" />
            </div>

...
const Navbar = ({ authenticate, setAuthenticate, goToHome }) => {
    ...
    return (
        <div className='main-header'>
            ...
            <div className='main-logo'>
                <img width={90} src="http://dbfla6302.dothome.co.kr/Study/React/noonarProject/hnm-react-router-practice/H&M-Logo.png" onClick={goToHome} alt="" />
            </div>
